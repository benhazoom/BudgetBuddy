...
import { Typography, Box, Card, CardContent, LinearProgress, Avatar } from '@mui/material';
...
const ExpenseCard: React.FC<ExpenseCardProps> = ({ category, totalSpent, budgetAmount, ratio, progress }) => {
        ...
        <Card sx={{ 
            ...
            <CardContent>
                ...
                <Typography variant="body2" color="text.secondary" gutterBottom>
                    Spent: ${totalSpent} / Goal: ${budgetAmount}
                </Typography>
